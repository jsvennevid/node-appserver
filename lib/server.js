...
_.extend(Server.prototype, {
        ...
        async.series([
            ...
            function (callback) {
                ...
                io.use(function (socket, next) {
                    ...
                    if (sid) {
                        var decodedSID = cookieParser.signedCookie(sid, config.session.secret);

                        data.sessionID = decodedSID;
                        data.sessionStore = sessionStore;

                        sessionStore.get(decodedSID, function (err, sess) {
                            if (err || !sess) {
    ...
    createBaseRequests: function () {
        ...
        var clientSource = fs.readFileSync(require.resolve('socket.io-client/dist/socket.io.min.js'), 'utf-8');
        ...
        app.get('/lib/socket.io.js', function (req, res) {
            ...
            res.writeHead(200);
            debug('client source: ' + clientSource);
