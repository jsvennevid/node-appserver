                ...
                (new AWS.RDS()).describeDBInstances({
                    ...
                    do {
                        if (data.DBInstances.length == 0) {
                            debug("could not find any database instances");
                            break;
                        }

                        var instance = data.DBInstances[0];
                        if (instance.Engine != 'mysql') {
                            debug("returned database instance is not running MySQL");
                            break;
                        }
                    ...
                    callback("Could not retrieve AWS MySQL database instance");
                });
            } break;
        }
    }
